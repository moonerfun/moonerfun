...
export const TokenStats: React.FC<TokenStatsProps> = memo(({ className }) => {
  ...
  return (
    ...
    >
      <div
        className={cn(
          'grid grid-cols-4 divide-x divide-neutral-800 border border-neutral-800 text-xs rounded-t-xl bg-neutral-900/50'
        )}
      >
...
>(({ className, value, ...props }, ref) => {
  ...
  return (
    <ToggleGroupPrimitive.Item
      ref={ref}
      className={cn(
        'flex flex-col items-center justify-center whitespace-nowrap py-2.5 px-3 text-neutral-500 transition-all',
        'data-[state=off]:hover:bg-neutral-800/50 data-[state=off]:hover:text-neutral-300',
        'data-[state=on]:bg-neutral-800 data-[state=on]:text-white',
    ...
    >
      ...
      <div className={cn('font-semibold text-sm', getNumberColorCn(priceChange))}>
