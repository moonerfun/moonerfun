...
export function DirectSwap({ mint }: DirectSwapProps) {
  ...
  return (
    <div className="p-4 space-y-4">
      ...
      <div className="space-y-2">
        ...
        <div className="flex items-center gap-2 bg-neutral-800 rounded-lg p-3">
          <input
            ...
            placeholder="0.0"
            className="flex-1 bg-transparent text-xl text-white outline-none placeholder-neutral-500"
          />
          ...
          <div className="flex gap-2">
            {[25, 50, 75, 100].map((pct) => (
              <button
                ...
                className="flex-1 py-1 px-2 text-xs bg-neutral-700 hover:bg-neutral-600 rounded text-neutral-200"
              >
                {pct}%
              </button>
            ))}
      ...
      {quote && (
        <div className="bg-neutral-800 rounded-lg p-3 space-y-2 text-sm">
          <div className="flex justify-between text-neutral-400">
            ...
            <span className={quote.priceImpact > 5 ? 'text-gold-400' : 'text-neutral-200'}>
      ...
      {!connected ? (
        <button
          className="w-full py-3 rounded-lg bg-primary hover:bg-primary-600 text-neutral-950 font-medium"
          onClick={() => {
